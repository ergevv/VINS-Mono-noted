...
$$
\mathbf{r}_{\text{prior}}(\mathbf{x}) \approx
...
$$
\mathbf{r}(\mathbf{x}_m,\mathbf{x}_r) \approx
\bar{\mathbf{r}} +
...
$$
\text{原始非线性因子} \Rightarrow
\text{VINS-Mono 中通常按当前估计重线性化}
$$

$$
\text{边缘化压缩后的先验因子} \Rightarrow
...
$$
\mathbf{J}_{prior}(\bar{\mathbf{x}})\mathbf{n} \approx
\mathbf{0},
\quad
\mathbf{J}_{vision}(\bar{\mathbf{x}})\mathbf{n} \approx
\mathbf{0},
\quad
\mathbf{J}_{imu}(\bar{\mathbf{x}})\mathbf{n} \approx
\mathbf{0}
$$
